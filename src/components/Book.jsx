          ...
          <div className="space-y-8 order-last md:order-first">
            <div className="flex flex-col-reverse md:flex-col">
              <div className="space-y-6 md:space-y-8">
                <h2 className="text-white-1 text-3xl md:text-4xl 3xl:text-[49px] uppercase">
                  Patrick Bet-David&apos;s
                </h2>
                <h2 className="flex flex-col space-y-4 font-bold uppercase text-4xl md:text-5xl lg:text-6xl 3xl:text-[70px] bg-gradient-to-b from-red-4 to-red-1 text-transparent bg-clip-text">
